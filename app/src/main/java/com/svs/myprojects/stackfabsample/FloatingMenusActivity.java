...
public class FloatingMenusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_floating_menus);
        ...
        programFab1.setImageResource(android.R.drawable.ic_menu_edit);//(R.drawable.ic_edit);
        ...
        programFab2.setImageResource(android.R.drawable.ic_menu_edit);//(R.drawable.ic_edit);
        ...
        scaleInX.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                menu3.getMenuIconView().setImageResource(menu3.isOpened()
                        ? android.R.drawable.ic_menu_close_clear_cancel : android.R.drawable.ic_menu_agenda);
